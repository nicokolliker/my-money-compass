...
-- Add demo data flag to profiles
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS has_demo_data boolean NOT NULL DEFAULT false;
...
BEGIN
  ...
  -- Accounts
  INSERT INTO public.accounts (id, user_id, name, currency, type, opening_balance, sort_order) VALUES
    (v_acc_usd, p_user_id, 'Main USD Account', 'USD', 'bank', 5000, 1),
    (v_acc_ars, p_user_id, 'Banco Galicia ARS', 'ARS', 'bank', 500000, 2),
    (v_acc_wise, p_user_id, 'Wise USD', 'USD', 'digital_wallet', 1200, 3);
...
-- Update handle_new_user to also seed demo data
